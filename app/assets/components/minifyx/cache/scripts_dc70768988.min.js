...
$(document).ready(function(){var $watchOffset=$('.header-form-block').offset().top-$('h1').offset().top;var $watchOffset2=$('.screen2 h2').offset().top;$(window).scroll(function(){if($(this).scrollTop()>$watchOffset&&($(this).scrollTop()<$watchOffset2)&&(parseInt($('.container').css('width'))>780)){$("#babywatch").css('transform','translateY('+($(this).scrollTop()-$watchOffset)+'px)');}});$('.owl-carousel').owlCarousel({loop:true,margin:10,nav:false,responsive:{0:{items:1,autoHeight:true},768:{items:2,autoHeight:false}}});$("a.smooth-link").click(function(){$("html, body").animate({scrollTop:$($(this).attr("href")).offset().top+"px"},{duration:500,easing:"swing"});return false;});$("a.smooth-link2").click(function(){return $("html, body").animate({scrollTop:$($(this).attr("href")).offset().top-$(this).parent().parent().parent().height()+"px"},{duration:500,easing:"swing"}),!1})
$('.popup-with-move-anim').magnificPopup({type:'inline',fixedContentPos:false,fixedBgPos:true,overflowY:'auto',closeBtnInside:true,preloader:false,midClick:true,removalDelay:300,mainClass:'my-mfp-slide-bottom'});$('.zoom-gallery').magnificPopup({delegate:'a',type:'image',closeOnContentClick:false,closeBtnInside:false,mainClass:'mfp-with-zoom mfp-img-mobile',image:{markup:'<div class="mfp-figure">'+'<div class="mfp-close"></div>'+'<div class="mfp-top-bar">'+'<div class="mfp-counter"></div>'+'</div>'+'<div class="mfp-img"></div>'+'<div class="mfp-bottom-bar">'+'<div class="mfp-title"></div>'+'<div class="mfp-counter"></div>'+'</div>'+'</div>',cursor:'mfp-zoom-out-cur',titleSrc:'title',verticalFit:true,tError:'<a href="%url%">The image</a> could not be loaded.'},gallery:{enabled:true,preload:[1,3]},zoom:{enabled:true,duration:300,opener:function(element){return element.find('img');}}});var $fixedOffset=$('.screen1').offset().top;$(window).scroll(function(){$(this).scrollTop()>$fixedOffset?$(".fixed-menu").slideDown(200):$(".fixed-menu").slideUp(200)});$('.navbar-toggle').click(function(){$('.phone-nav').slideToggle("fast");});$('.phone-nav a').click(function(){$('.phone-nav').slideToggle("fast");});});